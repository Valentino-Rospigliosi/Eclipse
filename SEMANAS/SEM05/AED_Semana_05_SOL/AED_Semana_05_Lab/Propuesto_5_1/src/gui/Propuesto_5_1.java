...
public class Propuesto_5_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Posición de la primera nota aprobatoria: " + an.posPrimeraNotaAprobatoria());
		imprimir("Posición de la penúltima nota desaprobatoria: " + an.posPenultimaNotaDesaprobatoria());
	}

	protected void actionPerformedBtnGenerar(ActionEvent arg0) {
		an.generarNotas();
		imprimir("Notas generadas aleatoriamente. Pulse [Listar] para verlas.");
	}
