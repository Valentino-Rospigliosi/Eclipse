...
public class Propuesto_6_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnAdicionar(ActionEvent arg0) {
		try {
			double nuevaTemperatura = leerTemperatura();
			at.adicionar(nuevaTemperatura);
			listar();
		} catch (NumberFormatException e) {
			mensaje("Error de ingreso. Ingresa una temperatura válida.");
		}
	}
	...
	protected void actionPerformedBtnRemplazarPrimeraTemperaturaNormal(ActionEvent arg0) {
		try {
			...
			mensaje("No existe ninguna temperatura normal en el arreglo");
		}
	}
